...
function changeWeather(response, temp) {
    ...
    } else if (response == 'light rain' || response == 'heavy rain' || response == 'rain' || response == 'moderate rain') {
...
btn.addEventListener('click', function() {
    ...
    if (cityName != '') {
        ...
        const API = `https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=a033d83875a96369e9407b97df8cf124`;
        console.log(API);
